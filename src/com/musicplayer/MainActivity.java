...
public class MainActivity extends ListActivity {
	private final String EXTRAPATH = "com.musicplayer.Path";
	private final String CATEGORYNAME = "com.musicplayer.SAMPLE_CODE";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		startActivity(new Intent(this, AudioDecoderActivity.class));

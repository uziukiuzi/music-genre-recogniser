...
//    	//String selectionMimeType = MediaStore.Audio.Media.IS_MUSIC + " = 1";
//
//    	String mimeType = MimeTypeMap.getSingleton().getMimeTypeFromExtension("mp3"); 
//
//    	String[] selectionArgsMp3 = new String[]{ mimeType };
//
//    	Cursor cur = mContentResolver.query(uri, projection, selectionMimeType, selectionArgsMp3, sortOrder);
...
//        int columnIndex = cur.getColumnIndex(MediaStore.Aud)
    ...
    while(count < mItems.size()){
    	if(mItems.get(count).getTitle().equals(title)){
    		break;
    	} else{
    		count++;
    	}
    ...
    public static class Item {
        ...
        String album;
        long duration;
        public Item(long id, String path, String artist, String title, String album, long duration) {
            this.id = id;
            this.path = path;
            this.artist = artist;
            this.title = title;
